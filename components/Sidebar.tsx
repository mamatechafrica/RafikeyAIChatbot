...
import { Activity, Grid3X3, Users, ChevronLeft, Award } from "lucide-react";
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`fixed left-0 top-0 h-full backdrop-blur-md border-r transition-all duration-300 z-20 ${
      ...
      <div className="p-6">
        ...
        <a
          ...
          className={`flex items-center px-4 py-3 rounded-xl transition-all duration-300 hover:bg-opacity-10 group
              ...
              ${
                isDarkMode
                  ? "text-blue-400 hover:bg-blue-700/30 hover:text-white"
