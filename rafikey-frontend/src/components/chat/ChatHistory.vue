...
<template>
  <div
    class="flex justify-start py-2 ps-4 cursor-pointer active:"
    :class="[
      chatbotStore.sessionId === props.threadId
        ? 'bg-stone-300 dark:bg-stone-700  border-r-4 border-blue-600 '
