  ...
  <div class="chat chat-end">
    <div class="flex flex-row-reverse gap-2">
      ...
      <div class="flex flex-col">
        <div class="chat-header dark:text-white flex justify-end  items-end font-semibold text-sm md:text-lg">
          {{props.userName}}
        ...
        <div class=" bg-lightBackground dark:bg-darkgray p-4 rounded-2xl">
          <div v-if="hasText" v-html="props.userMessage" class="lg:!text-xl md:!text-lg !text-sm dark:text-white"></div>
        </div>
