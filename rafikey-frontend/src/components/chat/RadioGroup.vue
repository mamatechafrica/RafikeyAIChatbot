...
const emits = defineEmits<{
  (event: 'change', value: RadioOption): void
}>()
          ...
          >
            <div
              :class="[
                active ? '' : '',
                checked
                  ? 'bg-casablanca-600/75'
                  : ' border-button-light dark:bg-transparent bg-link-water-50 border ',
              ]"
                    ...
                    <div class="flex flex-row gap-3 items-center">
                      ...
                      >
                        <p
                          ...
                          :class="[checked ? 'text-white' : 'text-black dark:text-white']"
                        >
                          {{ rad.name }}
                        </p>
                      </RadioGroupDescription>
