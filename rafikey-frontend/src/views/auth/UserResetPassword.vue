              ...
              <form class="flex flex-col space-y-12 w-10/12">
                <div class="relative">
                  ...
                  <span
                    ...
                    class="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white material-icons-outlined absolute cursor-pointer right-3 top-6"
                    >visibility_off</span
                  >
                  <span
                    v-else
        ...
        <form class="space-y-8">
          <div class="relative space-y-2">
            ...
            <span
              v-if="isPasswordVisible"
              @click="isPasswordVisible = false"
              class="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white material-icons-outlined absolute cursor-pointer right-3 md:top-12 top-10"
              >visibility_off</span
            >
            <span
              v-else
