...
<template>
  <div class="min-h-screen w-full dark:bg-lightgray">
    <div class="w-10/12 mx-auto space-y-4 pb-10">
      ...
      <div class="bg-gray-100 dark:bg-darkgray mx-auto p-10 rounded-2xl space-y-5">
        <div>
          ...
          <div class="flex flex-col items-center space-y-3">
            <h2 class="md:text-extra-extra-large-1 text-large font-semibold dark:text-white">
              Terms of Use
            </h2>
        ...
        <div class="flex flex-col lg:text-xl text-lg dark:text-white space-y-4 lg:px-6 px-1">
          <div>
            <p class="md:text-large text-extra-small">
              ...
              chatting with our bot, playing games, or exploring service referrals, you're part of a
              community built on respect, safety, and empowerment.
              <br />
              By using Rafikey, you agree to follow these Terms of Use. They help ensure that
              everyone—no matter their background or identity—can engage freely and safely. Please
              take a moment to read them carefully to understand your rights, responsibilities, and
      ...
      <div
        v-if="chatbotStore.isShowTermsButton"
        class="fixed bottom-0 left-0 right-0 w-full py-4 bg-white dark:bg-lightgray"
      >
        <div class="flex justify-center text-gray-950 text-xl gap-16">
          <div
            @click="isTermsConditionHandler(false)"
            class="bg-transparent border border-casablanca-400 rounded-2xl text-small py-2 px-5 dark:text-white"
          >
            Decline
          </div>
          <div
            @click="isTermsConditionHandler(true)"
            class="bg-casablanca-400 rounded-2xl text-small py-2 px-5"
          >
            Accept
          </div>
        </div>
