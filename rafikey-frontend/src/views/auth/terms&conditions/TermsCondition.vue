    ...
    <div class="w-10/12 mx-auto space-y-4">
      ...
      <div class="bg-gray-100 mx-auto p-10 rounded-2xl space-y-5">
        ...
        <div class="flex flex-col lg:text-xl text-lg  space-y-4 lg:px-6 px-1">
          ...
          <div>
            <h2 class="lg:text-3xl text-xl font-semibold">2. Who Can Use Rafikey?</h2>
            <p>Rafikey is built for people aged 10 and above. If you are under 18, we recommend  telling a trusted adult you're using the service - but you don't have to if you're not comfortable.</p>
          </div>
          <div class="">
            <h2 class="lg:text-3xl text-xl font-semibold">3. Your Privacy Matters</h2>
            <ul class="list-disc pl-10">
          ...
          <div class="">
            <h2 class="lg:text-3xl text-xl font-semibold">4. Use Rafikey Respectfully</h2>
            <p>By using Rafikey, you agree to:</p>
            <ul class="list-disc pl-10">
            ...
            </ul><p>We never sell or share your information with third parties for advertising or tracking.</p>
            <p>Rafikey is here to support and guide - please use it kindly and responsibly.</p>
          </div>
          <div class="">
            <h2 class="lg:text-3xl text-xl font-semibold">5. This Is Not Emergency</h2>
            <p>Rafikey gives information and guidance, but it is not a substitute for emergency medical, mental health or legal help. If you are in danger, please reach out to a trusted adult, local clinic or emergency number in your country.</p>
          </div>
          <div class="">
            <h2 class="lg:text-3xl text-xl font-semibold">6. We May Improve Things</h2>
            <p>We're always working to make Rafikey better. That means we may update these terms from time to time. If we do, we'll let you know here or in the app.</p>
          </div>
          <div class="pb-24">
            <h2 class="lg:text-3xl text-xl font-semibold">7. Contact Us</h2>
