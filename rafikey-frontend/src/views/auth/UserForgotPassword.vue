...
<template>
  <div class="h-screen w-full py-8 overflow-hidden hidden lg:block
">
    <div class="w-10/12 grid grid-cols-2 mx-auto gap-8">
      ...
      <div class="col-span-1">
        ...
        <div class="flex flex-col space-y-12">
          ...
          >
            ...
            <span class="text-extra-small font-light ">Back to login</span>
          </div>
          ...
          <div>
            ...
            >
              <div class="relative">
                ...
                />
                <label
                  class="absolute left-1 -top-3 text-slate-600 px-1 text-text-extra-small bg-white "
                  for="email"
                >
                  Email address
                </label>
      ...
      <div class="col-span-1 flex items-center justify-center">
        <div class="bg-gray-100 rounded-2xl  h-5/6">
  ...
  <!--    Small screens-->
  <div class="lg:hidden block overflow-hidden h-screen w-full ">
    <div class="grid grid-cols-3 gap-4 items-center px-4 py-2">
      ...
      >
        <span class="material-icons-outlined ">chevron_left</span>
        <span class="text-extra-small font-light ">Back</span>
      </div>

      <div class="col-span-1flex justify-center">
        <img src="@/assets/images/rafikey-key.png" alt="rafikey-logo" class="w-40" />
      </div>
    </div>

    <div class="flex flex-col md:px-20 px-10 space-y-6">
      <div class="flex flex-col items-center space-y-4">
        <h2 class="text-extra-large font-semibold">Forgot Password</h2>
      ...
      <form class="space-y-8">
        <div class="space-y-3">
          <label for="email" class="text-black text-extra-small ">Email</label>
          <input
            v-model="emailData"
            id="email"
            type="email"
            class="w-full  border-[1px] border-gray-300  rounded-2xl  md:p-4 p-3 text-extra-small "
            required
